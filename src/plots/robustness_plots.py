...
def plot_1():
    for i in [10,50,100,200]:
        for d in [1]:
            ...
            labels = {1:'Requests',2:'Baseline',10:'Driver Fairness',14:'Rider Fairness',15:'Profit'}
...
def plot_4():
    for q in [10,50,100,200]:
        for d in [1]:    
            labels = {1:'Request',10:'Driver Fairness',14:'Rider Fairness',15:'Profit'}
...
def plot_5():
    for q in [100]:
        for d in [0.25,0.5,1]:    
            labels = {1:'Request',2:'Baseline',10:'Driver Fairness',14:'Rider Fairness',15:'Profit'}
